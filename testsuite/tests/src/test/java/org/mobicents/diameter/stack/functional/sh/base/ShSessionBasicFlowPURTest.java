...
public class ShSessionBasicFlowPURTest {
  // TODO: add test on replicated nodes ?
  private ClientPUR clientNode;
  private ServerPUR serverNode1;
   ...
   */
  public ShSessionBasicFlowPURTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public void setUp() throws Exception {
    try {
      this.clientNode = new ClientPUR();
      this.serverNode1 = new ServerPUR();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<ShSessionBasicFlowPURTest> t = ShSessionBasicFlowPURTest.class;
