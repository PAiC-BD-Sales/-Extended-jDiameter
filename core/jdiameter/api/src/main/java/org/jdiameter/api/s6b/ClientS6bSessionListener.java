...
public interface ClientS6bSessionListener {
    ...
    void doAAAnswer(ClientS6bSession session, S6bAARequest request, S6bAAAnswer answer) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;

    void doReAuthRequest(ClientS6bSession session, S6bReAuthRequest request) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
    ...
    void doAbortSessionRequest(ClientS6bSession session, S6bAbortSessionRequest request) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
