 ...
 *
 */
public class ClientSLgPLR extends AbstractSLgImmediateClient {
  ...
  /* (non-Javadoc)
   * @see org.mobicents.diameter.stack.functional.slg.AbstractImmediateSLgClient#doProvideLocationAnswerEvent(
