...
public class ShSessionBasicFlowPNRTest {
  // TODO: add test on replicated nodes ?
  private ClientPNR clientNode;
  private ServerPNR serverNode1;
  ...
  public void setUp() throws Exception {
    try {
      this.clientNode = new ClientPNR();
      this.serverNode1 = new ServerPNR();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<ShSessionBasicFlowPNRTest> t = ShSessionBasicFlowPNRTest.class;
