...
public class CxDxSessionBasicFlowMARTest {
  ...
  @Test
  public void testMultimediaAuth() throws Exception {
    try {
    ...
    if (!serverNode1.isReceivedMultimediaAuth()) {
      StringBuilder sb = new StringBuilder("Did not receive MAR! ");
      sb.append("Server ER:\n").append(serverNode1.createErrorReport(this.serverNode1.getErrors()));

      fail(sb.toString());
    }
    if (!clientNode.isReceivedMultimediaAuth()) {
      StringBuilder sb = new StringBuilder("Did not receive MAA! ");
