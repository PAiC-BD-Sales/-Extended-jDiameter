...
public class ShSessionBasicFlowUDRTest {
  // TODO: add test on replicated nodes ?
  private ClientUDR clientNode;
  private ServerUDR serverNode1;
  ...
  public void setUp() throws Exception {
    try {
      this.clientNode = new ClientUDR();
      this.serverNode1 = new ServerUDR();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<ShSessionBasicFlowUDRTest> t = ShSessionBasicFlowUDRTest.class;
