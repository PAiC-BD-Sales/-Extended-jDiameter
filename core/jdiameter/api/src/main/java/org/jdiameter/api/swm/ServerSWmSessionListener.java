...
public interface ServerSWmSessionListener {
    void doDiameterEAPAnswer(ServerSWmSession session, SWmDiameterEAPRequest request, SWmDiameterEAPAnswer answer)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;

    void doAbortSessionRequest(ServerSWmSession session, SWmAbortSessionRequest request)
            throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
