...
import org.mobicents.diameter.stack.functional.slg.AbstractSLgImmediateServer;
 ...
 *
 */
public class ServerSLgPLA extends AbstractSLgImmediateServer {

  protected boolean receivedPLR;
  protected boolean sentPLA;

  // the following attribute is not meant to be here, but needed to be declared due to class inheritance
  ...
  // this doesn't belong here, but needed to be declared here due to class inheritance
  @Override
