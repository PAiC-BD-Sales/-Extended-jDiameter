...
public class ShSessionBasicFlowSNRTest {
  // TODO: add test on replicated nodes ?
  private ClientSNR clientNode;
  private ServerSNR serverNode1;
   ...
   */
  public ShSessionBasicFlowSNRTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public void setUp() throws Exception {
    this.clientNode = new ClientSNR();
    this.serverNode1 = new ServerSNR();
  ...
  @Test
  public void testSubscribeNotifications() throws Exception {
    try {
  ...
  public static Collection<Object[]> data() {
    ...
    Class<ShSessionBasicFlowSNRTest> t = ShSessionBasicFlowSNRTest.class;
